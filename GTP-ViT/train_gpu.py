...
from datasets import build_dataset, new_data_aug_generator
...
def speed_test(model, ntest=100, batch_size=32, x=None, **kwargs):
    if x is None:
...
def get_args_parser():
    parser = argparse.ArgumentParser('GTPViT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=8, type=int)
    parser.add_argument('--nb_classes', default=5, type=int)
    parser.add_argument('--epochs', default=300, type=int)
    parser.add_argument('--print_freq', default=50, type=int,
                        help='MetricLogger print_freq, see util.engine.py function: train_one_epoch')
    parser.add_argument('--val_print_freq', default=10, type=int,
                        help='MetricLogger val_print_freq, see util.engine.py funtion: evaluate')
    parser.add_argument('--bce-loss', action='store_true')
    parser.add_argument('--unscale-lr', action='store_true')

    # Model parameters
    parser.add_argument('--model', default='graph_propagation_deit_base_patch16_224', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_root', default='/flower_data', type=str, help='dataset path')
    ...
    parser.set_defaults(only_test_speed=False)
...
def main(args):
    ...
    if args.resume:
        if args.resume.endswith(".npz"):
            ...
            # elif args.resume.endswith(".safetensors"): # pip install safetensors
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('GTPViT training and evaluation script', parents=[get_args_parser()])
